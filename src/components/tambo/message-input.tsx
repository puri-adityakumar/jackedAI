  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "relative flex flex-col bg-background p-2 px-3",
            isDragging
        ...
        >
          {isDragging && (
            <div className="absolute inset-0 bg-primary/10 dark:bg-primary/10 flex items-center justify-center pointer-events-none z-20">
...
const MessageInputPlainTextarea = ({
  ...
  return (
    <textarea
      ...
      onPaste={handlePaste}
      className={cn(
        "flex-1 p-3 bg-background text-foreground resize-none text-sm min-h-[82px] max-h-[40vh] focus:outline-none placeholder:text-muted-foreground/50",
        className,
      )}
...
>(({ className, children, ...props }, ref) => {
  ...
  const buttonClasses = cn(
    "w-10 h-10 bg-foreground text-background hover:bg-foreground/90 disabled:opacity-50 flex items-center justify-center enabled:cursor-pointer",
    className,
  );
...
const ImageContextBadge: React.FC<ImageContextBadgeProps> = ({
  ...
  <div className="relative group flex-shrink-0">
    <button
      ...
      className={cn(
        "relative flex items-center border overflow-hidden",
    ...
    <button
      ...
      className="absolute -top-1 -right-1 w-5 h-5 bg-background border border-border text-muted-foreground flex items-center justify-center hover:bg-muted hover:text-foreground transition-colors z-10"
